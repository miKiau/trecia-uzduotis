...
public:
    ...
    reverse_iterator rbegin() noexcept { return avail; }
    const_reverse_iterator rbegin() const noexcept { return avail; }
    reverse_iterator rend() noexcept { return start; }
    const_reverse_iterator rend() const noexcept { return start; }
    const_iterator cbegin() const noexcept { return start; }
    const_iterator cend() const noexcept { return avail; }
    const_reverse_iterator crbegin() const noexcept { return avail; }
    const_reverse_iterator crend() const noexcept { return start; }
...
template <class T>
    void Vector<T>::grow() {
        ...
        // išskirti naują vietą
        iterator new_start = alloc.allocate(new_size);
        // perkopijuoja ir atiduota rodyklę į masyvo galą
        iterator new_avail = std::uninitialized_copy(start, avail, new_start);
